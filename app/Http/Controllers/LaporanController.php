...
class LaporanController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('laporan.index', compact('absensi', 'tanggalMulai', 'tanggalAkhir', 'status'));
    }
    ...
    public function pdf(Request $request)
    {
        ...
        $pdf = Pdf::loadView('laporan.pdf', compact('absensi', 'tanggalMulai', 'tanggalAkhir', 'status'))
